...
--
			...
			{ 3, "그런가요?  " },
			{ 0, "음..   손님들이   서로   푸념이라던가..  " },
			{ 0, "각자의   삶에   대해서   이야기   하시는   것을   듣는게   제   유일한   즐거움이거든요.", 1 },
--
			{ nil, "정말이에요.   '손님'의   이야기를   듣는   것   외에는   아무 것도   할게   없거든요.  " },
			{ nil, "가끔   아무   말도   하지   않고   가시는   '손님'이   있는데   그   때는   정말   지루했어요.  " },
--
			{ 1, "삶의   이야기라..   아,   한   잔   더   주겠어?  " },
--
			{ nil, "사실   아까부터   드리던   술은   주문하신   싸구려   술이   아니라   꽤나   고급   술이에요.  " },
			{ nil, "말씀   하신   술이   없던   것은   아니지만..  "},
			{ nil, "어떤   술을   드려도   저에겐   손해가   없으니까요!  "},
--
			{ 0, "네,  안주는   서비스에요.  " },
			{ 1, "오우,  고마워.  " },
			...
			{ 3, "...  "},
			{ 3, "좀..   생각해   보겠습니다." },
			{ 2, "괜찮아요!   원래   자기   이야기   같은거   막   말하는   게   더   이상한   거니가요.", 1 },
	...
	{
		{
			{ nil, "나는   스페스라는   시골   마을   출신이야.  " },
			{ nil, "나   같은   시골   출신   남자는   도시에   나가   병사가   되는   것을   목표로   하지.  " },
			{ nil, "어렸을   때부터   부모님이  " },
			{ nil, "'넌   커서   병사가   되어야   한다'  "},
			{ nil, "라고   말씀하시는   걸   언제나   듣고   자랐거든.  "}
		},
		{
			{ -1, "bgm"}
		...
		},
		{
			...
			{ nil, "그   자식은   힘이   풀린   듯이   쓰러졌고  "},
			{ nil, "나는   그를   뒤로   하고   시험관에게   보고하러   갔지."}
		},
		{
			{ 5, "이 XXX가!!!!  "},
			{ nil, "그런데   갑자기   달려들더라고?  "}
		...
		{
			{ 1, "ㅁ..뭣?!  "},
			{ nil, "그   때는   이미   죽었구나   생각했지.   그런데,  "},
			{ 4, "괜찮나,   21번   후보생?  "},
			{ nil, "시험관이   날   지키다가   오른쪽   팔을   다쳤지.  "}
		},
		{
			{ -1, "bgm"},
			{ 1, "그   후   치료는   잘   되긴   했지만..  "},
		...
		},
		{
			...
			{ 2, "그딴   괴물   후딱   무찌르고   예쁜   아내랑   평생   꽁냥꽁냥   해버리라고!  "},
			{ 7, "..다들   고마워!  "},
			{ 7, "반드시..   살아남겠어.  "},
			{ 7, "그러니까   아가씨도   그만   울어.  "},
			{ 0, "..죄송합니다  "},
	...
	{
		{
			...
			{ 2, "졸업   후엔   전공   살려서   지금   다니고   있는   모   IT기업에   프로그래머로 입사했어.  "},
			{ 2, "창업을   할까   고민도   해봤지만  "},
		...
		{
			{ nil, "네.   흔히   말하는   '블랙기업'에   들어간거죠.  "},
			{ nil, "진짜   한   달간   집에   못   가고   일한   적도   있었죠.  "},
			{ nil, "그리고   제가   그   회사에서   가장   프로그래밍을   잘하기도   해서.  "}
		},
		{
			{ 11, "화린씨!   이거   왜이래?  "},
			{ 9, "뭔데요.  "},
		...
		{ -- 여기 존댓말로 수정해야 함
			{ nil, "어쨌거나   이   회사   다니면서   성격이   많이   거칠어졌어.  "},
			{ nil, "사축은..   직장   동료들이   나한테   붙인   별명이고..  "},
			{ nil, "뭐..   부정할   수   없지만..  "},
			{ nil, "...  "},
			{ nil, "맨날   야근의   반복이고   대부분   일을   내가   하기도   하고..  "},
			{ nil, "밥도   제대로   못   먹고   항상   에너지   드링크를   달고   다니고..  "},
			{ nil, "그러다가   한   번   쓰러졌었지.  "},
			{ nil, "그제서야   난   좀   쉴   수   있었어.  "},
			{ nil, "밀린   연차   써서   2주   정도   휴가를   냈지.  "},
			{ nil, "그때   대학때   알고   지내던   남자를   만났지.  "},
		},
		{
			{ 16, "아,   여기야!  "},
			{ 9, "응,   오랜만이네.  "},
			...
			{ 9, "아..   그렇긴   하지..  "},
			{ nil, "나도   여러   곳   찔러서   겨우   들어간   곳이   블랙기업이었으니..  "}
		},
	}
}
